...
const firstParagraph = `The following application gets a list of documents from a remote server and use that remote server to check the validity of those documents.`;
const secondParagraph = `The last column in the table contains a button that allows a user to validate a document. The result of validation is shown via status circles, which show the progress in standard way:`;
